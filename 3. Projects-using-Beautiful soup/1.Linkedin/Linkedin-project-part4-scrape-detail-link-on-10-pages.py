'''
This is a simple python script to login to linked-in via user credentials and search for people based on specific skill. Then scrape the details of the search result i.e prints the links to specific individual on search page. 

Here the data is scraped for first 10 pages only.
